...
; after it has been shifted left N bits ? Could the upper bit be the sign ... left/right?
...
;   bit 1 = 1P start (1 if pressed)
;   bit 2 = 2P start (1 if pressed)
;   bit 3 = Always 1
...
0006  00        nop             ; Gap before next 8-byte RST slot
0007  00        nop             ; Gap before next 8-byte RST slot

;<EditorTab name="InterruptService">
;=RST 1============================================================
...
000f  00        nop             ; Gap before next 8-byte RST slot
...
001d  cdcd17    call    #CheckAndHandleTilt
...
002d  3aeb20    ld      a,(#NumberCredits)	; Number of credits
...
0038  32eb20    ld      (#NumberCredits),a	; New number of credits
...
0050  3aeb20    ld      a,(#NumberCredits)
0053  a7        and     a
...
; 00e2 - 00ff 00's
00e2  0000000000000000000000000000
...
077f  3aeb20    ld      a,(#NumberCredits)	; Number of credits
...
079e  3aeb20    ld      a,(#NumberCredits)	; Number of credits
07a1  80        add     a,b		; Take away credits
07a2  27        daa     		; Convert back to DAA
07a3  32eb20    ld      (#NumberCredits),a	; New credit count
...
084c  d306      out     (#06),a	        ; Feed the watchdog
...
090e  d306      out     (#06),a	        ; Feed watchdog
...
0a85  d306      out     (#06),a	        ; Feed watchdog
...
0b77  d306      out     (#06),a	         ; Feed watchdog
...
17d2  3a9a20    ld      a,(#IsTilt)	; Already in TILT handle?
17d5  a7        and     a		; 1 = yes
...
17e5  329a20    ld      (#IsTilt),a	; ... handling TILT
...
17fa  af        xor     a		; Zero
17fb  329a20    ld      (#IsTilt),a	; TILT handle over
...
1947  3aeb20    ld      a,(#NumberCredits)	; Number of credits
...
; Player sprite    
1c60  00000f1f1f1f1f7fff7f1f1f1f1f0f000
1c50  000000001a3d68fcfc683d1a00000000
...
1f48  0003047804030000 ; 29:"" Upside-down Y14141414140000 ; 27:"="
1f40  0022147f14220000 ; 28:"*"
